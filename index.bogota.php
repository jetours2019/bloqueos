 <div class="text-xs font-weight-bold text-primary text-uppercase mb-1" style="">Bogotá <i class="fas fa-arrows-alt-h"></i> <? echo $hacia3; ?></div>
...
$consulta=mysqli_query($conexion,"select * from productos  where ano = '$elA' AND mes = '$elM' AND desde='BOG' AND hasta='$hacia3' ") or die(mysqli_error($conexion));
...
$consulta=mysqli_query($conexion,"select * from productos  where ano = '$elA' AND mes = '$prox' AND desde='BOG' AND hasta='$hacia3' ") or die(mysqli_error($conexion));
$registro=mysqli_fetch_array($consulta);
