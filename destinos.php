...
.card-header {font-weight: bold;color: #2248ab;text-align: center;font-size: 2em;}
a.dest {
        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12 mb-4">
              <div class="card shadow mb-4 tituloDest">
               ...
               <h1><? echo $mes2 ?> / <? echo $ano ?></h1>
              </div>
            </div>

          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Saliendo desde <? echo $desde2 ?></h1>
