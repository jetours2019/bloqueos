      ...
      <li class="nav-item">
        ...
        <div id="collapsePasto" class="collapse <?php if ($_GET['desde'] == "PSO") echo 'show'; ?> " aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item <?php if ($_GET['desde'] == "PSO" && $_GET['mes'] == 9) echo 'showMes'; ?>" href="<?php echo $level_file; ?>/pages/visualizacion/destinos.php?mes=8&ano=2021&desde=PSO">Septiembre</a>
            <a class="collapse-item <?php if ($_GET['desde'] == "PSO" && $_GET['mes'] == 10) echo 'showMes'; ?>" href="<?php echo $level_file; ?>/pages/visualizacion/destinos.php?mes=8&ano=2021&desde=PSO">Octubre</a>
            <a class="collapse-item <?php if ($_GET['desde'] == "PSO" && $_GET['mes'] == 11) echo 'showMes'; ?>" href="<?php echo $level_file; ?>/pages/visualizacion/destinos.php?mes=8&ano=2021&desde=PSO">Noviembre</a>
            <a class="collapse-item <?php if ($_GET['desde'] == "PSO" && $_GET['mes'] == 12) echo 'showMes'; ?>" href="<?php echo $level_file; ?>/pages/visualizacion/destinos.php?mes=8&ano=2021&desde=PSO">Diciembre</a>
            <h6 class="collapse-header">2022</h6>
