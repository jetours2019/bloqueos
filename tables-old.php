...
.alertas:after {content: "(i) Hace mas de 4 horas que no se actualiza las tablas.";
font-size: 12px;
background: red;
color: white;
padding: 0px 8px;
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="mb-4 tituloDest">
              ...
              <h1><? echo $destino2 ?></h1>
              <h4>Saliendo desde <? echo $desde2 ?></h4>
          </div>

          <!-- DataTales Example -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Salidas en <? echo $mes2 ?></h6>
            </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                $consulta=mysqli_query($conexion,"select * from productos  where ano = '$ano' AND mes = '$mes' AND desde='$desde'  AND hasta='$destino' ") or die(mysqli_error($conexion));
                ...
                switch ($mes) {
                   ...
                   case 7:
                    ...
                    $consulta2=mysqli_query($conexion,"select * from productos  where referencia = '$referencia' AND fecha != '$fecha'") or die(mysqli_error($conexion));
                    ...
                    if($fecha == $fecha2){
                        ...
                        echo "
                        <tr>
                        <td>$desde - $hacia <span class='vuelo'>$tipo</span></td>
                        <td>$desde2 - $hacia2 <span class='vuelo'>$tipo2</span></td>
                        <td>$mes2</td>
                        ...
                        <td align='center'><a href='detalles.php?id=$referencia&desde=$desde' title='$referencia'><i class='fas fa-search-plus'></i></a></td>
                        </tr>     
                        ";
                    };
